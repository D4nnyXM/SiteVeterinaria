...
import Secao from "./components/Secao"; // Importa o componente Secao
import Cartao from "./components/Cartao"; // Importa o componente Cartao
import Titulo from "./components/Titulo"; // Importa o componente Titulo
import Formulario from "./components/Formulario"; // Importa o componente Formulario
import Formulario2 from "./components/Formulario2"; // Importa o componente Formulario2

import './App.css'; // Importa o arquivo de estilos CSS

const App = () => { // Define o componente principal App
